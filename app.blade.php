...
<body class="hold-transition skin-black fixed sidebar-mini"  data-csrf="eyJuYW1lIjoiY3NyZl90b2tlbl80YTQ0MzEyMmE3NGEyMTY0ODFhN2M2NTAxYzM4Njk4YyIsImhhc2giOiJkOWM3NDEzNGU2NTc3ZjhhMmI4MjY1ODU3NmNhZGNmMyJ9">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="pull-right hidden-xs">
                <b><a href="https://test1.playthriftgift.com/dashboard" target="_blank">SolutionWeb</a> {{Lang::get('core.version')}}</b> 1.0.0
            </div>
