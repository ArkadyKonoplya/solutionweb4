	...
	<div class="row">
	 <div class="col-sm-7">
  	...
  	<input type="hidden" name="page" value="{{ $param['page']}}" />
		<input id="ajaxsearch" name="search" class="select-alt" style="width:100px;float:left; display:none" value="<?php if(!is_null(Request::get('search'))) echo Request::get('search') ;?>" />
